            ...
            <div className="max-w-6xl mx-auto px-6 md:px-12 text-center">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-12">
                    {features.map((feature, index) => (
                        <motion.div
                            key={index}
                            className="bg-gradient-to-b from-white to-blue-50 rounded-xl p-8 shadow-lg border border-gray-200 flex flex-col items-center text-center transition-all duration-500"
                ...
                >
                    {}
                    <div>
                        <h3 className="text-2xl font-bold mb-2">Хотите узнать, сколько вы сможете сэкономить?</h3>
                        <p className="text-lg">Оставьте заявку, и мы рассчитаем вашу экономию бесплатно.</p>
                    </div>
