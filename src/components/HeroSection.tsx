            ...
            <div className="container mx-auto text-center max-w-screen-xl">
                ...
                <div className="mt-6 flex justify-center">
                    ...
                    >
                        ...
                        >
                            <MousePointerClick className="w-4 h-4 mr-1" /> Узнать больше
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                    <div
                        className="bg-kobi text-white p-8 rounded-[30px] shadow-md"
                        style={{
                            maxWidth: "440px",
                            minHeight: "200px",
                            height: "auto",
                    ...
                    <div
                        className="bg-anakiwa text-white p-8 rounded-[30px] shadow-md"
                        style={{
                            maxWidth: "440px",
                            minHeight: "200px",
                            height: "auto",
                    ...
                    <div
                        className="bg-yellow-sea text-white p-8 rounded-[30px] shadow-md"
                        style={{
